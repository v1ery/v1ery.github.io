(function(){
  ...
  var translations = {
    id: {
      ...
      'hero.cta_primary': 'Lihat Projects →',
      'hero.scroll': 'SCROLL',
      'stats.langs.label': 'Bahasa Pemrograman',
      'stats.security.label': 'Tools Keamanan',
      'stats.security.desc': 'Nmap, Burp Suite, Metasploit, Ghidra, dan lainnya',
      ...
      'demos.eyebrow': '$ ls ./demo',
      'demos.heading': 'Demos',
      'demos.desc': 'Eksplorasi desain & prototipe yang saya buat sendiri di luar proyek klien.',
    ...
    'stats.security.label': 'Security Tools',
    'stats.security.desc': 'Nmap, Burp Suite, Metasploit, Ghidra, and more',
    ...
    'demos.eyebrow': '$ ls ./demo',
    'demos.heading': 'Demos',
    'demos.desc': 'Design explorations and prototypes I have created independently, outside of client projects.',
    'demos.cta': 'View demo →',
  ...
  */
  ...
  function getTermLines(lang){
    ...
    return [
      ...
      {type:'out', text:'> Data Entry & Cleaning Specialist'},
      {type:'out', text:'> Cyber Security Enthusiast (Pentester)'},
...
document.addEventListener("DOMContentLoaded", () => {
  // Hanya jalankan animasi kompleks jika pengguna tidak menghidupkan reduce-motion
